...
**Munki:** import the [pkg from Releases](https://github.com/ofirgalcon/NetworkRPM/releases/latest/download/NetworkRPM.pkg) — receipt is `com.gal.NetworkQuality`. Prefer the versioned pkg (`NetworkRPM-x.y.z.pkg`) from the same [Releases](https://github.com/ofirgalcon/NetworkRPM/releases) page when you need a pinned file.
